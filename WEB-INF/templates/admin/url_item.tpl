    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title"><{$title}></h1>
                    <ul class="breadcrumb">
            <li><a href="./">主页</a> </li>
            <li><a href="view.php?type=3"><{$title}></a> </li>
...
<ul class="nav nav-tabs">
  <li class="active"><a href="#home" data-toggle="tab">审核</a></li>
</ul>
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        ...
        <label>当前地址:</label>
        <span><{$orign_value}></span>
        </div>
      <form id="tab" method="post" action="save_confirm.php">
      ...
      <div class="btn-toolbar list-toolbar">
        <button class="btn btn-primary"><i class="fa fa-save"></i>确认修改</button>
      </div>
    </form>
  </div>
</div>
