  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> 鑫锐和保险销售有限公司</span></a></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" action="sign-in.php">
                ...
                <button class="btn btn-primary pull-right submit">登录</button>
